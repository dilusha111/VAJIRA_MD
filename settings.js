...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=3B00RAjD#b36ru-0GLTyB8q-DfswCeZEdKnB3MYOpBtzln241EtA' : process.env.SESSION_ID,
...
ALIVE:  process.env.ALIVE  || '*`> SITHU BHH🤭`*'  ,    
